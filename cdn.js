const JSap = async function get() {
  /* API POSTS */
  const response = await fetch("https://almaghrebsport.com/wp-json/wp/v2/posts");
  ...
  document
    ...
    .insertAdjacentHTML(
      "beforeend",
      '<link rel="stylesheet" href="//cdn.statically.io/gh/StingTeamDev/Po-api/main/cdn.css" />'
    );
  ...
  document.querySelector("#PAutoSting1 a").innerHTML =
  ...
  document.querySelector("#PAutoSting2 a").innerHTML =
  ...
  document.querySelector("#PAutoSting3 a").innerHTML =
  ...
  document.querySelector("#PAutoSting4 a").innerHTML =
  ...
  document.querySelector("#PAutoSting5 a").innerHTML =
  ...
  document.querySelector("#PAutoSting6 a").innerHTML =
  ...
  document.querySelector("#PAutoSting7 a").innerHTML =
  ...
  document.querySelector("#PAutoSting8 a").innerHTML =
  ...
  Poo1.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[0].title.rendered;
  ...
  Poo2.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[1].title.rendered;
  ...
  Poo3.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[2].title.rendered;
  ...
  Poo4.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[3].title.rendered;
  ...
  Poo5.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[4].title.rendered;
  ...
  Poo6.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[5].title.rendered;
  ...
  Poo7.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[6].title.rendered;
  ...
  Poo8.addEventListener("click", () => {
    document.querySelector(".contentv1 h1").innerHTML = data[7].title.rendered;
